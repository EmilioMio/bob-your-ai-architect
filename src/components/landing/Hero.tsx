  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="section-container relative z-10 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight text-foreground mb-6" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          <motion.p className="text-3xl sm:text-4xl md:text-5xl font-semibold text-muted-foreground mb-8" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          duration: 0.6,
          delay: 0.3
        }}>Your personal AI code Architecture Team that learns your needs, generates project structures, and keeps your codebase consistent from the first commit to production.</motion.p>
